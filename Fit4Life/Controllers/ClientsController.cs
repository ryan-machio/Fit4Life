...
namespace Fit4Life.Controllers
{
    public class ClientsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,FirstName,LastName,Gender,Email,Age,Height,Weight,FatMass,LeanBodyMass,TotalDailyEnergyExpenditure,LastUpdate")] Clients clients)
        {
            if (id != clients.ID)
            {
                return NotFound();
